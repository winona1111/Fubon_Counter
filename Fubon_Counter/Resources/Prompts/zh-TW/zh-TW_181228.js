...
function zhTWcardinalPrompts(number)
{
    ...
    while (number > 0) {
        ...
        if (endDigits != 0) {
			...
			promptsArray = zhTWfourDigitsPrompts(endDigits,magnitude,numbertwo).concat(zhTWmagnitudePrompts(magnitude), promptsArray);
        }
...
function zhTWfourDigitsPrompts(number,magnitude,numbertwo)
{
